...
<div class="col-md-8 col-md-offset-2">
	<div class="panel panel-default">
		<div class="panel-heading">
			@if ($type == 'project') 프로젝트@elseif($type == 'study') 스터디@endif 만들기
		</div>
		<div class="panel-body">
		
			<form class="form-horizontal" role="form" method="POST" action="/group/{{$type}}/create">
				{{ csrf_field() }}
				...
				<div class="form-group{{ $errors->has('git') ? ' has-error' : '' }}">
					<div class="col-md-12">
						...
						<input id="git" type="git" class="form-control" name="git" value="{{ old('git') }}">
						 @if ($errors->has('git'))
							<span class="help-block">

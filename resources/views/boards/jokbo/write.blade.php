		...
		<div class="card-content">
			<form class="write-form" id="postForm" role="form" method="POST" action="/{{$boardid}}/write" enctype="multipart/form-data" onsubmit="return postForm('main')">
				...
				<div class="form-group">
					<input id="input-subject" type="text" name="subject" placeholder="과목" title="띄어쓰기, 특수문자 없이 풀네임으로" class="input-title" autocomplete="off" required autofocus>
				...
				<div class="form-group">
					<input id="input-professor" type="text" name="professor" placeholder="교수님" title="성이름 형태의 본명으로, 외국인인 경우 PascalCase" class="input-title" autocomplete="off" required>
